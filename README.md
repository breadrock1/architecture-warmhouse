...
- Пользователи могут управлять отоплением (вкл/откл);
- Система поддерживает…
- …

**Мониторинг температуры:**

- Пользователи могут в режиме реального времени получать информацию о температуре в квартире через веб-интерфейс;
- Система поддерживает…
- …
...
как организовано взаимодействие между компонентами и так далее.
 ...
 - Структура проекта представляет из себя разделение по типу функциональности, т.е. handler, models, routers отделены. DDD не используется;
 - 
...
Опишите здесь домены, которые вы выделили.
 ...
 - *Домен: Управление отоплением*:
   - поддомен управления системой отопления:
     - контекст: подключение к системе;
     - контекст: влючение/отключение отопления;
   - поддомен мониторинг температуры:
     - контекст: получение значения температуры в режиме реального времени. 
